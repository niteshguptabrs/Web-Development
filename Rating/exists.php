...
$query = mysqli_query($connection,"select (AVG(Rating)/5)*100 as Average from review_star where Movie='Exists' ");
?>
					...
					<div class="page">
						...
						<div class="content">
							<div class="row">
								...
								<div class="col-md-6">
									<h2 class="movie-title">Exists</h2>
									...
									<div>
										...
										<input type="hidden" name="movie" value="Exists"></input>
									</div>	
									<br/>
									<div class="rate">	
