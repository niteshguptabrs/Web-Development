...
$query = mysqli_query($connection,"select (AVG(Rating)/5)*100 as Average from review_star where Movie='Maleficient' ");
?>
					...
					<div class="page">
						...
						<div class="content">
							<div class="row">
								...
								<div class="col-md-6">
									<h2 class="movie-title">Maleficient</h2>
									...
									<div>
										...
										<input type="hidden" name="movie" value="Maleficient"></input>
									</div>	
									<br/>
									<div class="rate">	
