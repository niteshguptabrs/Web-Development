...
$query = mysqli_query($connection,"select (AVG(Rating)/5)*100 as Average from review_star where Movie='The adventure of Tintin' ");
?>
			...
			<main class="main-content">
				<div class="container">
					<div class="page">
						...
						<span>The adventure of Tintin</span>
						</div>
						...
						<div class="content">
							<div class="row">
								...
								<div class="col-md-6">
									<h2 class="movie-title">The adventure of Tintin</h2>
									...
									<div>
										...
										<input type="hidden" name="movie" value="The adventure of Tintin"></input>
									</div>	
									<br/>
									<div class="rate">	
